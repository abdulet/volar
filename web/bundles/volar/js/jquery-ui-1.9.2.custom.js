...
function Datepicker() {
	...
	this.regional['ca'] = { // Default regional settings
		closeText: 'Fet', // Display text for close link
		prevText: 'Anterior', // Display text for previous month link
		nextText: 'Seguent', // Display text for next month link
		currentText: 'Avui', // Display text for current month link
		monthNames: ['Gener','Febrer','Març','Abril','Maig','Juny',
			'Juliol','Agost','Stembre','Octobre','Novembre','Decembre'], // Names of months for drop-down and formatting
		monthNamesShort: ['Gen', 'Feb', 'Mar', 'Abr', 'Mai', 'Jun', 'Jul', 'Ago', 'Set', 'Oct', 'Nov', 'Dec'], // For formatting
		dayNames: ['Diumenge', 'Dilluns', 'Dimarts', 'Dimecres', 'Dijous', 'Divendres', 'Disabte'], // For formatting
		dayNamesShort: ['Dm', 'Dll', 'Dim', 'Dmx', 'Dij', 'Div', 'Dis'], // For formatting
		dayNamesMin: ['Dm','Dll','Dm','Dx','Dj','Dv','Ds'], // Column headings for days starting at Sunday
		weekHeader: 'Set', // Column header for week of the year
	...
	this.regional['es'] = { // Default regional settings
		...
		monthNames: ['Enero','Febrero','Marzo','Abril','Mayo','Junio',
			'Julio','Augost','Septiembre','Octubre','Noviembre','Diciembre'], // Names of months for drop-down and formatting
